	...
	public class EventDispatcher : Binder, IEventDispatcher, ITriggerProvider, ITriggerable
	{
		...
		virtual protected void invokeEventCallback(object data, EventCallback callback)
		{
			...
			catch(InvalidCastException)
			{
				...
				string message = "An EventCallback is attempting an illegal cast. One possible reason " +
          "is not typing the payload to IEvent in your callback. Another is illegal casting of " +
