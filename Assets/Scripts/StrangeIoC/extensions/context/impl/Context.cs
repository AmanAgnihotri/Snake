...
namespace strange.extensions.context.impl
{
	public class Context : Binder, IContext
	{
		...
		public Context(object view, bool autoMapping) : this(view, (autoMapping) ?
      ContextStartupFlags.MANUAL_MAPPING : ContextStartupFlags.MANUAL_LAUNCH | ContextStartupFlags.MANUAL_MAPPING) {}
